...
public class ProxyTestHelper {
    ...
    static final EntityId personId = new EntityId(EntityId.EntityType.PERSON, UUID.randomUUID(), EntityId.Durability.DURABLE);
    static final EntityId businessId = new EntityId(EntityId.EntityType.BUSINESS, UUID.randomUUID(), EntityId.Durability.DURABLE);
    static final EntityId phoneId = new EntityId(EntityId.EntityType.PHONE, UUID.randomUUID(), EntityId.Durability.DURABLE);
    static final EntityId locationId = new EntityId(EntityId.EntityType.LOCATION, UUID.randomUUID(), EntityId.Durability.DURABLE);
